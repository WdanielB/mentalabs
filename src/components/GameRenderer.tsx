...
function AttentionGame({ config, onComplete, preview }: GameRendererProps) {
 ...
 return (
 <div className="p-8 text-center bg-purple-50 rounded-2xl border border-purple-200 ">
 ...
 <div className="h-32 w-32 bg-slate-300 " style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }} />
 )}
 </button>
 </div>
 );
