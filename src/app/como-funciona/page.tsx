...
export default function ComoFuncionaPage() {
 ...
 <div className="relative z-10 flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border-4 border-white shadow-lg" style={{ background: color }}>
 ...
 <h3 className="font-display text-xl font-700 text-slate-900 mb-2">{title}</h3>
 ...
 <h2 className="font-display text-3xl font-800 text-slate-900 mb-4">
 Listo para empezar
 </h2>
 ...
 <Link href="/marketplace" className="inline-flex items-center gap-2 px-8 py-4 text-base font-semibold text-slate-600 hover:text-[#136dec] transition-colors">
 Buscar especialista
 </Link>
 </div>
 </div>
