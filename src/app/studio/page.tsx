    ...
    <div className="min-h-screen bg-white dark:bg-[#0d1520] text-slate-900 dark:text-slate-100">
      <nav className="fixed top-0 z-50 w-full border-b border-slate-100/80 bg-white/90 backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#0d1520]/90">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <Link href="/login" className="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-[#136dec] transition-colors">Acceder</Link>
        </div>
      </nav>
      ...
      <div className="pt-32 pb-20 px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/como-funciona" className="inline-flex items-center gap-2 px-6 py-4 text-base font-semibold text-slate-600 dark:text-slate-300 hover:text-[#136dec] transition-colors group">
      ...
      {/* Features */}
      <div className="bg-slate-50 dark:bg-[#0a1018] py-20 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-display text-3xl font-800 text-slate-900 dark:text-white mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={title} className="p-6 bg-white dark:bg-[#131f2e] rounded-2xl border border-slate-200 dark:border-slate-700">
