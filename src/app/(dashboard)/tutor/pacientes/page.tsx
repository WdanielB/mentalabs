...
export default function TutorPacientesPage() {
 ...
 <p className="font-bold text-slate-700 text-lg">Sin pacientes vinculados</p>
 ...
 >
 <div className="h-11 w-11 rounded-full bg-slate-400 flex items-center justify-center text-white font-bold shrink-0">
 ...
 {p.results.map((r) => (
 <div key={r.id} className="flex items-center justify-between gap-3 p-3 bg-slate-50 rounded-xl">
 <div>
