...
export default function PacienteJuegosPage() {
 ...
 return (
 <div key={game.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-md hover:border-slate-300 transition-all">
 ...
 const bg = game?.bg ?? "bg-slate-50 ";
 const text = game?.text ?? "text-slate-500";
 return (
 <div key={s.id} className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-200 shadow-sm">
