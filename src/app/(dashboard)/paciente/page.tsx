...
export default function PacienteHomePage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="bg-white dark:bg-[#1a2432] rounded-xl border border-slate-200 dark:border-slate-800 p-5 mb-6 flex items-center gap-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#1a2432] p-4 flex items-center gap-3">
          <div className="h-10 w-10 rounded-lg bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center shrink-0">
            <ClipboardList className="h-5 w-5 text-amber-600" />
          </div>
          <div>
            {loading ? <div className="h-6 w-8 rounded bg-slate-200 dark:bg-slate-700 animate-pulse mb-1" /> : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        {/* Pending Exams */}
        <div className="lg:col-span-3 bg-white dark:bg-[#1a2432] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            ...
            {!loading && pendingExams.length === 0 && (
              <div className="px-5 py-10 text-center">
                ...
                <p className="font-semibold text-slate-700 dark:text-slate-300 text-sm">Todo al día</p>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white dark:bg-[#1a2432] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div className="p-5">
              {loading && <div className="h-20 rounded-lg bg-slate-100 dark:bg-slate-800 animate-pulse" />}
              {!loading && !nextAppointment && (
                <div className="text-center py-4">
                  <Calendar className="h-7 w-7 mx-auto mb-2 text-slate-300 dark:text-slate-600" />
          ...
          {/* Diary shortcut */}
          <div className="bg-white dark:bg-[#1a2432] rounded-xl border border-slate-200 dark:border-slate-800 p-5">
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 w-full py-2 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 rounded-lg text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            >
