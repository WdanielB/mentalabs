...
const MOOD_CONFIG: Record<Mood, { icon: React.ElementType; label: string; color: string }> = {
 bien: { icon: SmilePlus, label: "Bien", color: "text-emerald-600 bg-emerald-50 border-emerald-200" },
 regular: { icon: Meh, label: "Regular", color: "text-amber-600 bg-amber-50 border-amber-200" },
 mal: { icon: Frown, label: "Mal", color: "text-red-500 bg-red-50 border-red-200" },
};
...
export default function PacienteDiarioPage() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-slate-900 ">Mi Diario</h1>
